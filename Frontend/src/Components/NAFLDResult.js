...
const NAFLDResultPage = () => {
  const location = useLocation();
  const navigate = useNavigate();

  // Get the prediction result from the location state
      ...
      <div className="mt-8 p-6 bg-white shadow-lg rounded-md">
        ...
        {prediction === 1 ? (
          <div className="text-center">
            ...
            Risk of complications detected. NAFLD might be a contributing factor.
            </h3>
            <img
          ...
          <div className="text-center">
            <h3 className="text-green-600 text-lg font-semibold">
              No immediate risk detected. Maintain regular health checkups.
            </h3>
            <img
       ...
       <div className="mt-6">
          <h3 className="text-lg font-medium text-center text-gray-600 mt-2">
            Probability score: <span className="text-red-500">{probability_of_disease}%</span>
          </h3>
...
export default NAFLDResultPage;